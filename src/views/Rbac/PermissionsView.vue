<template>
  <div>
    ...
    >
      ...
      <el-table-column prop="name" label="权限姓名" width="180">
      </el-table-column>
      <el-table-column prop="address" label="上级Id" width="180">
      </el-table-column>
      <el-table-column prop="name" label="路径" width="180"> </el-table-column>
      <el-table-column prop="address" label="排序id" width="180">
      </el-table-column>
    </el-table>
...
<script>
import PermissionsAdd from "../../components/Permission/PermissionsAdd.vue";
export default {
