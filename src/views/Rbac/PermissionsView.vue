<template>
  <div>
    ...
    >
      ...
      <el-table-column prop="SuperiorId" label="上级Id" width="180">
      </el-table-column>
      <el-table-column prop="Url" label="路径" width="180"> </el-table-column>
      <el-table-column prop="OrderId" label="排序id" width="180">
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    GetAll() {
      ...
      this.axios
        .get("https://localhost:5001/api/Power/GetData", token)
        .then((res) => {
          var data = res.data;
          if (data.Code == 200) {
            this.tableData = [];
    ...
    Delete(val) {
      ...
      this.$confirm("此操作将永久删除该文件, 是否继续?", "提示", {
        ...
        .then(() => {
          this.axios
            .post("https://localhost:5001/api/Power/Delete", list)
            .then((res) => {
              var state = res.data;
              if (state == true) {
                this.$message({
